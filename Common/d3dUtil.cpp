    ...
    Microsoft::WRL::ComPtr<ID3D12Resource>& uploadBuffer)
{
    ...
    D3D12_RESOURCE_DESC&& resource_desc = CD3DX12_RESOURCE_DESC::Buffer(byteSize);
    ...
    D3D12_RESOURCE_BARRIER&& resource_barrier = CD3DX12_RESOURCE_BARRIER::Transition(defaultBuffer.Get(),
        D3D12_RESOURCE_STATE_COMMON, D3D12_RESOURCE_STATE_COPY_DEST);
    cmdList->ResourceBarrier(1, &resource_barrier);
    resource_barrier = CD3DX12_RESOURCE_BARRIER::Transition(defaultBuffer.Get(),
